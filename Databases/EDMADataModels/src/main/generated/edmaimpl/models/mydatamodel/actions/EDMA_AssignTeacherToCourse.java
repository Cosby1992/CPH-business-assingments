 ...
 * 
 */
public class EDMA_AssignTeacherToCourse extends AAction implements IAction
{
    private AssignTeacherToCourseUserImpl edma_userMethod;
     ...
     */
    public EDMA_AssignTeacherToCourse(AssignTeacherToCourseUserImpl edma_userMethod)
    {
        super("assignTeacherToCourse");
    ...
    public boolean execute(IDataModelUpdate edma_dm)
    {
        ...
        switch(e)
        {
            case 0:
                ...
                break;
            case 1:
                edma_userMethod.setErrorCode(1, "Teacher ID does not exist");
                break;
            case 2:
                edma_userMethod.setErrorCode(2, "Course ID does not exist");
                break;
            case 3:
                edma_userMethod.setErrorCode(3, "There can only be one Teacher on a course");
                break;
            default:
                throw new RuntimeException("Error in assignTeacherToCourse: Invalid error code: " + e);
        }
        return (e == 0);
    }
     ...
     */
    public AssignTeacherToCourseUserImpl getUserMethod()
    {
