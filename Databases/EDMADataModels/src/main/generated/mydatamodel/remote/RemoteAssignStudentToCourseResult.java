 ...
 * 
 */
public class RemoteAssignStudentToCourseResult implements AssignStudentToCourseResult
{
     ...
     */
    public RemoteAssignStudentToCourseResult(int edma_errorCode, String edma_errorMsg, String edma_errorDesc)
    {
