...
/**
 * The implementation of AnyArray
 */
public class AnyArrayImpl extends AnyArray implements IValueInstance
{
    ...
    /**
     * Compare this AnyArray to another AnyArray
     * @param anyArray  The AnyArray to compare with
     * @return          A negative integer, zero, or a positive integer as this
     *                  AnyArray is less than, equal to, or greater than the
     *                  specified AnyArray
     */
    public int compareTo(AnyArray anyArray)
    {
        return edma_domain.valueCompare(value, ((AnyArrayImpl) anyArray).value);
    }
    ...
    {
        return new ValueImpl(value[index]);
    }
     ...
     * 
     */
    public class AnyArrayIterator implements Iterator<Value>
    {
        private int pos;
        ...
        public Value next()
        {
            return new ValueImpl(value[pos++]);
        }
