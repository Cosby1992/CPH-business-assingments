...
/**
 * The implementation of AnyBool
 */
public class AnyBoolImpl extends AnyBool implements IValueInstance
{
     ...
     */
    public AnyBoolImpl(Object value)
    {
        this.value = value;
    }
    ...
    /**
     * Compare this AnyBool to another AnyBool
     * @param anyBool  The AnyBool to compare with
     * @return         A negative integer, zero, or a positive integer as this
     *                 AnyBool is less than, equal to, or greater than the
     *                 specified AnyBool
     */
    public int compareTo(AnyBool anyBool)
    {
        return edma_domain.valueCompare(value, ((AnyBoolImpl) anyBool).value);
    }
